...
impl Hash for ResourceKey<crate::Buffer> {
    fn hash<H: Hasher>(&self, hasher: &mut H) { self.0.native_ptr().hash(hasher) }
}
...
pub struct TransferBatch {
    ...
    copy_buffers: HashMap<(ResourceKey<crate::Buffer>, ResourceKey<crate::Buffer>), Vec<VkBufferCopy>>,
...
impl TransferBatch {
    ...
    pub fn add_buffer_graphics_ready(
        &mut self, dest_stage: br::PipelineStageFlags,
        res: &crate::Buffer, byterange: Range<br::vk::VkDeviceSize>, access_grants: br::vk::VkAccessFlags
    ) {
    ...
    pub fn add_image_graphics_ready(
        &mut self, dest_stage: br::PipelineStageFlags, res: &crate::Image, layout: br::ImageLayout
    ) {
        self.ready_barriers.entry(dest_stage).or_insert_with(ReadyResourceBarriers::new)
    ...
    fn update_barrier_range_for(
        ...
        k: ResourceKey<crate::Buffer>, new_range: Range<br::vk::VkDeviceSize>
    ) {
...
impl DescriptorSetUpdateBatch {
    ...
    pub fn write_index(
        &mut self, dest: br::vk::VkDescriptorSet, bound: u32, array: u32, info: br::DescriptorUpdateInfo
    ) -> &mut Self {
