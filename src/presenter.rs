...
pub trait PlatformPresenter {
    fn new(g: &crate::Graphics) -> Self;
    fn emit_initialize_backbuffer_commands(&self, recorder: &mut br::CmdRecord);
    fn current_backbuffer_index(&mut self) -> u32;
    fn render_and_present<NL>(
        &mut self,
        e: &crate::Engine<NL>,
...
struct IntegratedSwapchainObject {
    ...
    backbuffer_images: Vec<br::ImageView>
}
...
impl IntegratedSwapchain {
    ...
    pub fn render_and_present<'s, NL>(
        &'s mut self,
        e: &crate::Engine<NL>,
        q: &br::Queue,
        bb_index: u32,
        ...
        if let Some(mut cs) = update_submission {
            ...
            e.submit_buffered_commands(&[cs, render_submission], e.last_rendering_completion_object())
            ...
            e.submit_buffered_commands(&[render_submission], e.last_rendering_completion_object())
