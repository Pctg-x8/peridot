        ...
        , List/end_map GithubActions.Step.Type (withConditionStep precondition) [
            ...
            , GithubActions.Step::{
                ...
                , run = Some
                    ...
                    ''
                , env = Some (toMap { VK_SDK_PATH = "", PERIDOT_CLI_CRADLE_BASE = "$Env:GITHUB_WORKSPACE/cradle" })
                }
            , GithubActions.Step::{
    ...
    , steps = List/concat GithubActions.Step.Type [
        , List/end_map GithubActions.Step.Type (withConditionStep precondition) [
            ...
            , GithubActions.Step::{
                ...
                , env = Some (toMap { VK_SDK_PATH = "", PERIDOT_CLI_CRADLE_BASE = "$GITHUB_WORKSPACE/cradle" })
                }
            ]
