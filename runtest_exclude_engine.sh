...
(echo checking vertex-processing-pack; cd modules/vertex-processing-pack && cargo check --verbose --features=bedrock/VK_EXT_debug_report) || exit 3
(echo checking vg; cd modules/vg && cargo check --verbose --features=bedrock/VK_EXT_debug_report) || exit 3
