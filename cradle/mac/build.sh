...
$SCRIPT_PATH/../../target/release/peridot-archiver new $ASSET_PATH/* -o $SCRIPT_PATH/peridot-cradle/assets.par
...
if [ $AFTER_RUN -ne 0 ]; then
    open $SCRIPT_PATH/peridot-cradle/build/Debug/peridot-cradle.app
fi
