...
#[repr(C)]
pub struct udev(OpaqueFFIStruct);
#[repr(C)]
pub struct udev_list_entry(OpaqueFFIStruct);
#[repr(C)]
pub struct udev_device(OpaqueFFIStruct);
#[repr(C)]
pub struct udev_monitor(OpaqueFFIStruct);
#[repr(C)]
pub struct udev_enumerate(OpaqueFFIStruct);
#[repr(C)]
pub struct udev_queue(OpaqueFFIStruct);
#[repr(C)]
pub struct udev_hwdb(OpaqueFFIStruct);
