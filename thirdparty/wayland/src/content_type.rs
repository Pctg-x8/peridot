...
impl ProxyObject for WpContentTypeManagerV1 { #[inline(always)] fn as_proxy(&self) -> &Proxy { &self.0 } }
...
impl ProxyObject for WpContentTypeV1 { #[inline(always)] fn as_proxy(&self) -> &Proxy { &self.0 } }
