...
static ZWLR_LAYER_SHELL_V1_INTERFACE: ffi::Interface = ffi::Interface {
...
#[repr(transparent)]
pub struct ZwlrLayerShellV1(pub(crate) Proxy);
unsafe impl Interface for ZwlrLayerShellV1 {
    const DEF: *const ffi::Interface = &ZWLR_LAYER_SHELL_V1_INTERFACE;

    #[cfg_attr(
        feature = "tracing",
        tracing::instrument(name = "<ZwlrLayerShellV1 as Interface>::destruct", skip(self))
    )]
...
impl ZwlrLayerShellV1 {
    ...
    ) -> crate::Result<crate::Owned<crate::ZwlrLayerSurfaceV1>> {
        Ok(unsafe {
            crate::Owned::wrap_unchecked(self.0.marshal_array_typed(
                ...
                &mut [
                    crate::NEWID_ARG,
                    surface.0.as_arg(),
                    output.map_or(crate::NULLOBJ_ARG, |x| x.0.as_arg()),
                    layer.as_arg(),
                    ffi::Argument {
                        s: namespace.as_ptr(),
                    },
...
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum ZwlrLayerShellV1Layer {
    Background = 0,
    Bottom = 1,
    Top = 2,
    Overlay = 3,
...
static ZWLR_LAYER_SURFACE_V1_INTERFACE: ffi::Interface = ffi::Interface {
    ...
    methods: const {
        [
            ...
            ffi::Message {
                ...
                types: const { [crate::XdgPopup::DEF] }.as_ptr(),
            },
            ffi::Message {
...
#[repr(transparent)]
pub struct ZwlrLayerSurfaceV1(pub(crate) Proxy);
unsafe impl Interface for ZwlrLayerSurfaceV1 {
    const DEF: *const ffi::Interface = &ZWLR_LAYER_SURFACE_V1_INTERFACE;

    #[cfg_attr(
        feature = "tracing",
        tracing::instrument(name = "<ZwlrLayerSurfaceV1 as Interface>::destruct", skip(self))
    )]
    unsafe fn destruct(&mut self) {
...
impl ZwlrLayerSurfaceV1 {
    pub fn set_listener<'l, L: ZwlrLayerSurfaceV1EventListener + 'l>(
        &'l mut self,
        listener: &'l mut L,
    ) -> crate::SetListenerResult {
        extern "C" fn configure<L: ZwlrLayerSurfaceV1EventListener>(
        ...
        extern "C" fn closed<L: ZwlrLayerSurfaceV1EventListener>(
            data0: *mut core::ffi::c_void,
            sender0: *mut ffi::Proxy,
        ) {
            L::closed(unsafe { &mut *(data0 as *mut _) }, unsafe {
    ...
    pub fn set_size(&self, width: u32, height: u32) -> crate::Result<()> {
        self.0.marshal_array_void(
            0,
            &mut [ffi::Argument { u: width }, ffi::Argument { u: height }],
        )
    }

    #[inline]
    pub fn set_anchor(&self, anchor: ZwlrLayerSurfaceV1Anchor) -> crate::Result<()> {
        self.0.marshal_array_void(1, &mut [anchor.as_arg()])
    }

    #[inline]
    pub fn set_exclusive_zone(&self, zone: i32) -> crate::Result<()> {
        self.0
            .marshal_array_void(2, &mut [ffi::Argument { i: zone }])
    }

    #[inline]
    pub fn set_margin(&self, top: i32, right: i32, bottom: i32, left: i32) -> crate::Result<()> {
        self.0.marshal_array_void(
            3,
            &mut [
                ffi::Argument { i: top },
                ffi::Argument { i: right },
                ffi::Argument { i: bottom },
                ffi::Argument { i: left },
            ],
        )
    }
    ...
    pub fn set_keyboard_interactivity(
        ...
        self.0
            .marshal_array_void(4, &mut [keyboard_interactivity.as_arg()])
    }

    #[inline]
    pub fn get_popup(&self, popup: &crate::XdgPopup) -> crate::Result<()> {
    ...
    pub fn ack_configure(&self, serial: u32) -> crate::Result<()> {
        self.0
            .marshal_array_void(6, &mut [ffi::Argument { u: serial }])
    }

    #[inline]
    pub fn set_layer(&self, layer: ZwlrLayerShellV1Layer) -> crate::Result<()> {
        self.0.marshal_array_void(8, &mut [layer.as_arg()])
    }
}

pub trait ZwlrLayerSurfaceV1EventListener {
    fn configure(&mut self, sender: &mut ZwlrLayerSurfaceV1, serial: u32, width: u32, height: u32);
    fn closed(&mut self, sender: &mut ZwlrLayerSurfaceV1);
}

#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum ZwlrLayerSurfaceV1KeyboardInteractivity {
    None = 0,
    Exclusive = 1,
    OnDemand = 2,
}
