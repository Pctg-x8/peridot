...
static WP_SINGLE_PIXEL_BUFFER_MANAGER_V1_INTERFACE: ffi::Interface = ffi::Interface {
    name: c"wp_single_pixel_buffer_manager_v1".as_ptr(),
    version: 1,
    method_count: 2,
    methods: const {
        [
            ...
            ffi::Message {
                name: c"create_u32_rgba_buffer".as_ptr(),
                signature: c"nuuuu".as_ptr(),
                types: const {
                    [
                        crate::Buffer::DEF,
                        core::ptr::null(),
...
#[repr(transparent)]
pub struct WpSinglePixelBufferManagerV1(pub(crate) Proxy);
unsafe impl Interface for WpSinglePixelBufferManagerV1 {
    ...
    #[cfg_attr(
        feature = "tracing",
        tracing::instrument(
            name = "<WpSinglePixelBufferManagerV1 as Interface>::destruct",
            skip(self)
        )
    )]
...
impl WpSinglePixelBufferManagerV1 {
    ...
    pub fn create_u32_rgba_buffer(
        ...
        b: u32,
        a: u32,
    ) -> crate::Result<crate::Owned<crate::Buffer>> {
        Ok(unsafe {
